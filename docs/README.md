...
Index of all documentation for the WHPH (Work Hard Play Hard) project.

## Core

| Document                                     | Description                                                   |
| -------------------------------------------- | ------------------------------------------------------------- |
| [PRD.md](PRD.md)                             | Product Requirements Document — features, goals, user stories |
| [PROJECT-STRUCTURE.md](PROJECT-STRUCTURE.md) | Directory layout and architectural layer overview             |
