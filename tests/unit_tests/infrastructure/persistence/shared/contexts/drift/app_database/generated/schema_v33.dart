...
class HabitTimeRecordTable extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class NoteTable extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class NoteTagTable extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class TaskTable extends Table with TableInfo {
  ...
  late final GeneratedColumn<double> order = GeneratedColumn<double>(
      ...
      requiredDuringInsert: false,
      defaultValue: const CustomExpression('0.0'));
  late final GeneratedColumn<int> plannedDateReminderTime =
      GeneratedColumn<int>('planned_date_reminder_time', aliasedName, false,
          type: DriftSqlType.int,
          requiredDuringInsert: false,
          defaultValue: const CustomExpression('0'));
  late final GeneratedColumn<int> deadlineDateReminderTime =
      GeneratedColumn<int>('deadline_date_reminder_time', aliasedName, false,
          type: DriftSqlType.int,
          requiredDuringInsert: false,
          defaultValue: const CustomExpression('0'));
  ...
  late final GeneratedColumn<String> recurrenceParentId =
      GeneratedColumn<String>('recurrence_parent_id', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  late final GeneratedColumn<String> recurrenceConfiguration =
      GeneratedColumn<String>('recurrence_configuration', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  @override
  List<GeneratedColumn> get $columns => [
        id,
...
class DatabaseAtV33 extends GeneratedDatabase {
  ...
  late final HabitTimeRecordTable habitTimeRecordTable =
      HabitTimeRecordTable(this);
