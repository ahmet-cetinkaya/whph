...
import 'package:infrastructure_shared/infrastructure_container.dart';
...
import 'package:whph/shared/utils/error_helper.dart';
import 'package:domain/shared/utils/logger.dart';
import 'package:application/shared/services/abstraction/i_logger_service.dart';
import 'package:whph/ui_presentation_container.dart';
...
class AppBootstrapService {
  ...
  static Future<void> _startBackgroundWorkers(IContainer container) async {
    ...
    final androidSyncService = AndroidSyncService(mediator, transactionService);
