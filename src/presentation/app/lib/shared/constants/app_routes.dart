...
import 'package:whph/features/app_usages/pages/app_usage_details_page.dart';
import 'package:whph/features/app_usages/pages/app_usage_rules_page.dart';
import 'package:whph/features/calendar/pages/today_page.dart';
import 'package:whph/features/habits/pages/habit_details_page.dart';
import 'package:whph/features/app_usages/pages/app_usage_view_page.dart';
import 'package:whph/features/habits/pages/habits_page.dart';
import 'package:whph/features/notes/pages/note_details_page.dart';
import 'package:whph/features/notes/pages/notes_page.dart';
import 'package:whph/features/settings/pages/settings_page.dart';
import 'package:whph/features/sync/pages/sync_devices_page/sync_devices_page.dart';
import 'package:whph/features/tags/pages/tags_page.dart';
import 'package:whph/features/tasks/pages/task_details_page.dart';
import 'package:whph/features/tasks/pages/tasks_page.dart';
import 'package:whph/features/tasks/pages/marathon_page.dart';
import 'package:whph/features/sync/pages/qr_code_scanner_page.dart';
import 'package:whph/features/sync/pages/add_sync_device_page/add_sync_device_page.dart';
import 'package:whph/features/tags/pages/tag_details_page.dart';
