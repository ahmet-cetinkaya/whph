...
class AppLifecycleService with WidgetsBindingObserver {
  ...
  void _cleanupSystemTray() {
    ...
    _systemTrayService.destroy().catchError((error) {
      DomainLogger.error('Error cleaning up system tray: $error', component: 'AppLifecycleService');
    });
  }
  ...
  void _initializeSystemTray() {
    ...
    _systemTrayService.init().catchError((error) {
      DomainLogger.error('Error initializing system tray: $error', component: 'AppLifecycleService');
    });
  }
}
