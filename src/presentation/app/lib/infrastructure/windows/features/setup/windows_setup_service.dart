...
class WindowsSetupService extends BaseSetupService {
  ...
  Future<void> setupEnvironment() async {
    ...
    try {
      ...
      Logger.debug('Using icon path: $iconPath', component: _componentName);
      ...
      Logger.info('Windows environment setup completed successfully', component: _componentName);
    } catch (e) {
      Logger.error('Error setting up Windows environment: $e', component: _componentName);
    }
  }
