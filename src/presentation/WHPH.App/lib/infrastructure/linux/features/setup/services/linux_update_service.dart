  ...
  Future<String> getAppVersion() async {
    try {
      ...
      try {
        ...
        Logger.debug('Failed to get version from package_info: $e', component: _componentName);
      }
      ...
      Logger.warning('Could not determine app version, using default', component: _componentName);
      return '0.18.0';
    } catch (e) {
      Logger.debug('Error getting app version: $e', component: _componentName);
      return '0.18.0';
    }
  }
