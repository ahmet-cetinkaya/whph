...
import 'package:application/features/settings/commands/export_data_command.dart';
...
import 'package:application/features/settings/commands/delete_setting_command.dart';
import 'package:application/features/settings/queries/get_setting_query.dart';
import 'package:application/features/settings/queries/get_list_settings_query.dart';
...
void registerSettingsFeature(
  ...
  IImportDataMigrationService migrationService,
