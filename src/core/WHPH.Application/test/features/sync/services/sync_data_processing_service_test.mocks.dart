...
import 'package:whph_domain/features/tasks/models/task_with_total_duration.dart'
    as _i8;
import 'package:whph_domain/features/tasks/task.dart' as _i11;
...
class _FakeConflictResolutionResult_2<T1 extends _i1.BaseEntity<String>>
  ...
  _FakeConflictResolutionResult_2(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockIRepository<T extends _i1.BaseEntity<TId>, TId> extends _i2.Mock
  ...
  _i6.Future<_i1.PaginatedList<T>> getList(
    ...
    List<_i1.CustomOrder>? customOrder,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i6.Future<_i1.PaginatedList<T>>.value(
  ...
  @override
  _i6.Future<T?> getById(TId? id, {bool? includeDeleted = false}) =>
      (super.noSuchMethod(
            Invocation.method(
              #getById,
              [id],
...
class MockITaskRepository extends _i2.Mock implements _i7.ITaskRepository {
  ...
  @override
  _i6.Future<_i1.PaginatedList<_i8.TaskWithTotalDuration>> getListWithFilter({
    required int? pageIndex,
    required int? pageSize,
    _i9.TaskQueryFilter? filter,
    bool? includeDeleted = false,
  ...
  @override
  _i6.Future<_i1.PaginatedList<_i10.TaskListItem>> getListWithDetails({
    required int? pageIndex,
    required int? pageSize,
    _i9.TaskQueryFilter? filter,
    bool? includeDeleted = false,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i6.Future<_i1.PaginatedList<_i10.TaskListItem>>.value(
              _FakePaginatedList_1<_i10.TaskListItem>(
                this,
                Invocation.method(#getListWithDetails, [], {
                  #pageIndex: pageIndex,
                  #pageSize: pageSize,
          ...
          as _i6.Future<_i1.PaginatedList<_i10.TaskListItem>>);

  @override
  _i6.Future<List<_i11.Task>> getByParentTaskId(String? parentTaskId) =>
      (super.noSuchMethod(
            Invocation.method(#getByParentTaskId, [parentTaskId]),
            returnValue: _i6.Future<List<_i11.Task>>.value(<_i11.Task>[]),
          )
          as _i6.Future<List<_i11.Task>>);

  @override
  _i6.Future<List<_i11.Task>> getByRecurrenceParentId(
  ...
  @override
  _i6.Future<_i3.PaginatedSyncData<_i11.Task>> getPaginatedSyncData(
    DateTime? lastSyncDate, {
    int? pageIndex = 0,
    int? pageSize = 200,
    String? entityType,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i6.Future<_i3.PaginatedSyncData<_i11.Task>>.value(
              _FakePaginatedSyncData_0<_i11.Task>(
                this,
                Invocation.method(
                  #getPaginatedSyncData,
                  [lastSyncDate],
          ...
          as _i6.Future<_i3.PaginatedSyncData<_i11.Task>>);
  ...
  @override
  _i6.Future<_i1.PaginatedList<_i11.Task>> getList(
    int? pageIndex,
    int? pageSize, {
    bool? includeDeleted = false,
    _i1.CustomWhereFilter? customWhereFilter,
    List<_i1.CustomOrder>? customOrder,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i6.Future<_i1.PaginatedList<_i11.Task>>.value(
              _FakePaginatedList_1<_i11.Task>(
                this,
                Invocation.method(
                  #getList,
                  [pageIndex, pageSize],
          ...
          as _i6.Future<_i1.PaginatedList<_i11.Task>>);

  @override
  _i6.Future<List<_i11.Task>> getAll({
    bool? includeDeleted = false,
    _i1.CustomWhereFilter? customWhereFilter,
    List<_i1.CustomOrder>? customOrder,
  }) =>
  ...
  @override
  _i6.Future<_i11.Task?> getById(String? id, {bool? includeDeleted = false}) =>
      (super.noSuchMethod(
            Invocation.method(
              #getById,
              [id],
            ...
            returnValue: _i6.Future<_i11.Task?>.value(),
          )
          as _i6.Future<_i11.Task?>);

  @override
  _i6.Future<_i11.Task?> getFirst(
    _i1.CustomWhereFilter? customWhereFilter, {
    bool? includeDeleted = false,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> add(_i11.Task? item) =>
      (super.noSuchMethod(
            Invocation.method(#add, [item]),
            returnValue: _i6.Future<void>.value(),
            returnValueForMissingStub: _i6.Future<void>.value(),
  ...
  @override
  _i6.Future<void> update(_i11.Task? item) =>
      (super.noSuchMethod(
            Invocation.method(#update, [item]),
            returnValue: _i6.Future<void>.value(),
            returnValueForMissingStub: _i6.Future<void>.value(),
  ...
  @override
  _i6.Future<void> delete(_i11.Task? id) =>
      (super.noSuchMethod(
            Invocation.method(#delete, [id]),
            returnValue: _i6.Future<void>.value(),
            returnValueForMissingStub: _i6.Future<void>.value(),
...
class MockSyncConflictResolutionService extends _i2.Mock
  ...
  @override
  _i4.ConflictResolutionResult<T> resolveConflict<
    T extends _i1.BaseEntity<String>
  >(T? localEntity, T? remoteEntity) =>
      (super.noSuchMethod(
            Invocation.method(#resolveConflict, [localEntity, remoteEntity]),
  ...
  T copyRemoteDataToExistingTask<T extends _i1.BaseEntity<String>>(
    ...
    T? remoteTask,
      ...
      (super.noSuchMethod(
            Invocation.method(#copyRemoteDataToExistingTask, [
              existingTask,
              remoteTask,
            ]),
