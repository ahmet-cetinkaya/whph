...
import 'package:whph_application/features/tasks/commands/add_task_tag_command.dart';
import 'package:whph_application/features/tasks/commands/add_task_time_record_command.dart';
import 'package:whph_application/features/tasks/commands/delete_task_command.dart';
import 'package:whph_application/features/tasks/commands/remove_task_tag_command.dart';
import 'package:whph_application/features/tasks/commands/save_task_command.dart';
import 'package:whph_application/features/tasks/commands/save_task_time_record_command.dart';
import 'package:whph_application/features/tasks/commands/update_task_order_command.dart';
import 'package:whph_application/features/tasks/commands/update_task_tags_order_command.dart';
import 'package:whph_application/features/tasks/queries/get_list_task_tags_query.dart';
...
import 'package:whph_application/features/tasks/queries/get_total_duration_by_task_id_query.dart';
import 'package:whph_application/features/tasks/commands/import_tasks_command.dart';
...
import 'package:whph_application/features/tasks/services/task_recurrence_service.dart';
import 'package:whph_application/features/tasks/services/abstraction/i_reminder_calculation_service.dart';
import 'package:whph_application/features/tasks/services/reminder_calculation_service.dart';
...
void registerTasksFeature(
  ...
  // Note: CompleteTaskCommandHandler is registered in the presentation layer
  // because it depends on ITaskCompletionNotifier which is implemented by TasksService
  mediator
