...
class WhphHabitsWidgetProvider : AppWidgetProvider() {
  ...
  private fun setupHabitItems(
    context: Context,
    views: RemoteViews,
    habits: org.json.JSONArray?,
    habitCount: Int,
  ) {
    ...
    val habitCheckboxIds =
      arrayOf(
        R.id.habit_checkbox_1,
        R.id.habit_checkbox_2,
        R.id.habit_checkbox_3,
        R.id.habit_checkbox_4,
        R.id.habit_checkbox_5,
      )
    val habitTitleIds =
      arrayOf(
        R.id.habit_title_1,
        ...
        if (hasGoal && dailyTarget > 1) {
          ...
          if (currentCompletionCount > 0 && dailyTarget > 1) {
            ...
            val textColor =
              when {
                currentCompletionCount >= dailyTarget ->
                  context.getColor(R.color.success_color) // Green - completed
                currentCompletionCount > 0 ->
                  context.getColor(R.color.warning_color) // Amber - in progress
