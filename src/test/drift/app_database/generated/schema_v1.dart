...
class AppUsageTableData extends DataClass implements Insertable<AppUsageTableData> {
  ...
  @override
  int get hashCode => Object.hash(id, createdDate, modifiedDate, deletedDate, name, displayName, color, duration);
  @override
...
class TaskTableData extends DataClass implements Insertable<TaskTableData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || elapsedTime != null) {
  ...
  TaskTableCompanion toCompanion(bool nullToAbsent) {
    return TaskTableCompanion(
      ...
      elapsedTime: elapsedTime == null && nullToAbsent ? const Value.absent() : Value(elapsedTime),
  ...
  TaskTableData copyWith(
      ...
      TaskTableData(
        ...
        elapsedTime: elapsedTime.present ? elapsedTime.value : this.elapsedTime,
  ...
  TaskTableData copyWithCompanion(TaskTableCompanion data) {
    return TaskTableData(
      ...
      elapsedTime: data.elapsedTime.present ? data.elapsedTime.value : this.elapsedTime,
  ...
  @override
  int get hashCode => Object.hash(id, createdDate, modifiedDate, deletedDate, title, description, priority, plannedDate,
      deadlineDate, estimatedTime, elapsedTime, isCompleted);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class TagTableData extends DataClass implements Insertable<TagTableData> {
  ...
  @override
  int get hashCode => Object.hash(id, createdDate, modifiedDate, deletedDate, name, isArchived);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
