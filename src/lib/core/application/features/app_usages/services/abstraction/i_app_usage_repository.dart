...
abstract class IAppUsageRepository extends app.IRepository<AppUsage, String> {
  Future<DateTime?> updateIfRevision(AppUsage appUsage, DateTime expectedRevision);

  Future<DateTime?> deleteIfRevision(AppUsage appUsage, DateTime expectedRevision);
