...
enum PublicSettingKey {
  ...
  dynamicAccentEnabled(
      'dynamicAccentEnabled', SettingKeys.dynamicAccentColor, 'boolean', false),
  customAccentArgb('customAccentArgb', SettingKeys.customAccentColor,
  ...
  notificationsEnabled(
      'notificationsEnabled', SettingKeys.notifications, 'boolean', true),
  soundEnabled('soundEnabled', SettingKeys.soundEnabled, 'boolean', true),
  taskCompletionSoundEnabled('taskCompletionSoundEnabled',
      SettingKeys.taskCompletionSoundEnabled, 'boolean', true),
  habitCompletionSoundEnabled('habitCompletionSoundEnabled',
      SettingKeys.habitCompletionSoundEnabled, 'boolean', true),
  timerControlSoundEnabled('timerControlSoundEnabled',
      SettingKeys.timerControlSoundEnabled, 'boolean', true),
  timerAlarmSoundEnabled('timerAlarmSoundEnabled',
      SettingKeys.timerAlarmSoundEnabled, 'boolean', true),
  workMinutes('workMinutes', SettingKeys.workTime, 'integer', 25),
  breakMinutes('breakMinutes', SettingKeys.breakTime, 'integer', 5),
  longBreakMinutes(
      'longBreakMinutes', SettingKeys.longBreakTime, 'integer', 15),
  sessionsBeforeLongBreak('sessionsBeforeLongBreak',
      SettingKeys.sessionsBeforeLongBreak, 'integer', 4),
  autoStartBreak(
      'autoStartBreak', SettingKeys.autoStartBreak, 'boolean', false),
  autoStartWork('autoStartWork', SettingKeys.autoStartWork, 'boolean', false),
  tickingEnabled(
      'tickingEnabled', SettingKeys.tickingEnabled, 'boolean', false),
  ...
  keepScreenAwake(
      'keepScreenAwake', SettingKeys.keepScreenAwake, 'boolean', false),
  defaultTimerMode(
      'defaultTimerMode', SettingKeys.defaultTimerMode, 'string', 'pomodoro'),
  defaultPage('defaultPage', SettingKeys.defaultPage, 'string', '/today'),
  taskDefaultEstimatedMinutes('taskDefaultEstimatedMinutes',
      SettingKeys.taskDefaultEstimatedTime, 'integer', 0),
  taskDefaultPlannedReminder('taskDefaultPlannedReminder',
      SettingKeys.taskDefaultPlannedDateReminder, 'string', 'none'),
  taskDefaultPlannedReminderCustomOffsetMinutes(
      'taskDefaultPlannedReminderCustomOffsetMinutes',
      SettingKeys.taskDefaultPlannedDateReminderCustomOffset,
      'integer',
      0),
  taskSkipQuickAdd(
      'taskSkipQuickAdd', SettingKeys.taskSkipQuickAdd, 'boolean', false),
  habitThreeStateEnabled('habitThreeStateEnabled',
      SettingKeys.habitThreeStateEnabled, 'boolean', false),
  habitReverseDayOrder('habitReverseDayOrder', SettingKeys.habitReverseDayOrder,
      'boolean', false);

  const PublicSettingKey(
      this.publicName, this.storageKey, this.valueType, this.defaultValue);
  ...
  Object? normalize(Object? value) => switch (this) {
        ...
        uiDensity => _enum(
            value, const {'system', 'compact', 'normal', 'large', 'larger'}),
        ...
        defaultTimerMode =>
          _enum(value, const {'pomodoro', 'normal', 'stopwatch'}),
        defaultPage => _enum(value, const {
            '/today',
            '/tasks',
            '/habits',
            '/notes',
        ...
        taskDefaultPlannedReminderCustomOffsetMinutes =>
          _integer(value, 0, 10080),
        customAccentArgb =>
          value == null ? null : _integer(value, 0, 0xffffffff),
        _ => _boolean(value),
      };
...
final class PublicSettingRecord {
  const PublicSettingRecord(
      {required this.key, required this.value, required this.revision});
