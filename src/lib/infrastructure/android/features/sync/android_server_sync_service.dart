...
class AndroidServerSyncService extends AndroidSyncService {
  ...
  AndroidServerSyncService(super.mediator, this._deviceIdService, this._deviceInfoPlugin,
  ...
  Future<void> _handleWebSocketMessage(String message, WebSocket socket) async {
    try {
      ...
      switch (parsedMessage.type) {
        ...
        case 'sync':
          Logger.warning('Legacy sync endpoint called on mobile server - this is deprecated');
