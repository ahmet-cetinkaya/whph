...
class WindowsShortcutService implements IWindowsShortcutService {
  ...
  Future<void> createStartMenuShortcut({
    ...
    try {
      ...
      Logger.info('Created Start Menu shortcut at: $shortcutPath', component: _componentName);
    } catch (e) {
      Logger.error('Failed to create Start Menu shortcut: $e', component: _componentName);
      rethrow;
    }
  }
  ...
  Future<void> createShortcut({
    ...
    try {
      ...
      Logger.debug('Created shortcut: $shortcutPath', component: _componentName);
    } catch (e) {
      Logger.error('Failed to create shortcut: $e', component: _componentName);
      rethrow;
    }
  }
}
