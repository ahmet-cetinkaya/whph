...
class AndroidFileService implements IFileService {
  ...
  Future<String?> pickFile({
    ...
    try {
      DomainLogger.debug('Starting file pick with extensions: $allowedExtensions');
      ...
      DomainLogger.error('File pick error: $e');
  ...
  Future<void> writeFile({
    ...
    try {
      ...
      DomainLogger.debug('[AndroidFileService]: Successfully wrote file to: $filePath');
    } catch (e) {
      DomainLogger.error('[AndroidFileService]: Failed to write file: $e');
  ...
  Future<void> writeBinaryFile({
    ...
    try {
      ...
      DomainLogger.debug('[AndroidFileService]: Successfully wrote binary file to: $filePath (${data.length} bytes)');
    } catch (e) {
      DomainLogger.error('[AndroidFileService]: Failed to write binary file: $e');
  ...
  Future<String?> saveFile({
    ...
    try {
      DomainLogger.debug('[AndroidFileService]: Saving file using SAF: $fileName (${data.length} bytes)');
      ...
      if (savedPath == null) {
        DomainLogger.debug('[AndroidFileService]: User cancelled file save');
        return null;
      }

      DomainLogger.debug('[AndroidFileService]: Successfully saved file via SAF: $savedPath');
      return savedPath;
    } catch (e) {
      DomainLogger.error('[AndroidFileService]: Failed to save file: $e');
