...
class ShareToCreateService {
  ...
  Future<bool> handleShareFlow({
    ...
    DomainLogger.debug('ShareService: Extracted title: "$title", description: "$description"');
  ...
  Future<bool> _createItem({
    ...
    try {
      ...
      DomainLogger.error('ShareService: Error creating item: $e', stackTrace: stackTrace);
      _showNotification(
        translationService: translationService,
  ...
  Future<bool> _createTask({
    ...
    DomainLogger.debug('ShareService: Task created with ID: ${response.id}');
    _showNotification(
      translationService: translationService,
  ...
  Future<bool> _createNote({
    ...
    DomainLogger.debug('ShareService: Note created with ID: ${response.id}');
    _showNotification(
      translationService: translationService,
