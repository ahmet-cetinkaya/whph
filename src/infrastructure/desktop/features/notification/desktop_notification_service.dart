...
class DesktopNotificationService implements INotificationService {
  ...
  Future<void> handleNotificationTaskCompletion(String taskId) async {
    try {
      DomainLogger.info('DesktopNotificationService: Completing task from notification: $taskId');

      await _mediatr.send<CompleteTaskCommand, CompleteTaskCommandResponse>(
        CompleteTaskCommand(id: taskId),
      );

      DomainLogger.info('DesktopNotificationService: Task completed successfully from notification');
    } catch (e, stackTrace) {
      DomainLogger.error(
  ...
  Future<void> handleNotificationHabitCompletion(String habitId) async {
    try {
      DomainLogger.info('DesktopNotificationService: Completing habit from notification: $habitId');
      ...
      DomainLogger.info('DesktopNotificationService: Habit completed successfully from notification');
    } catch (e, stackTrace) {
      DomainLogger.error(
